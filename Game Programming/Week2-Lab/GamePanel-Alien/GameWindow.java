					   ...
					   MouseListener
{
	...
	public void actionPerformed(ActionEvent e) {
		...
		// write code to respond to a click on startB JButton
		//   which will draw the game entities (only alien for now)

		if (command.equals(focusB.getText()))
			mainPanel.requestFocus();

		if (command.equals(exitB.getText())) 	// Exit button is clicked
			System.exit(0);
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (gamePanel.isOnHead(x, y)) {
			statusBarTF.setText ("Mouse click on alien's head!");
