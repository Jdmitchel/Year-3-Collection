...
public class Boss {
    ...
    public void draw(Graphics2D g2){
        ...
        int barX = 5000; // X-coordinate of the health bar
        int barY = y - 500; // Y-coordinate of the health bar (adjust as needed)
